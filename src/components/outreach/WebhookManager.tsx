    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {loading ? (
          ...
          <>
            {/* Status summary */}
            <div className="flex items-center gap-2 p-3 rounded-none border border-border bg-muted/50">
            ...
            {webhooks.length > 0 && (
              <div className="space-y-2">
                {webhooks.map((webhook) => (
                  <div
                    key={webhook.id}
                    className="flex items-center justify-between p-3 rounded-none border border-border bg-card"
                  >
                    <div className="flex items-center gap-3">
