          ...
          {accounts.length === 0 ? (
            ...
            <div className="space-y-3">
              {accounts.map((account) => (
                <div
                  key={account.id}
                  className="flex items-center justify-between p-3 bg-muted/50 rounded-none border border-border"
                >
        ...
        <div className="p-4">
          {checkpoint ? (
            <div className="space-y-4">
              <div className="p-4 bg-yellow-50 border border-border rounded-none">
            ...
            <Tabs value={connectMethod} onValueChange={(v) => setConnectMethod(v as 'cookie' | 'credentials')}>
              ...
              <TabsContent value="cookie" className="space-y-4">
                <div className="p-3 bg-blue-50 border border-border rounded-none text-xs text-blue-700">
                ...
                {/* Multi-contract tip */}
                <TooltipProvider>
                  <div className="p-3 bg-purple-50 border border-border rounded-none text-xs text-purple-700">
              ...
              <TabsContent value="credentials" className="space-y-4">
                <div className="p-3 bg-yellow-50 border border-border rounded-none text-xs text-yellow-700">
