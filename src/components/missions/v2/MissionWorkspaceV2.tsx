...
export const MissionWorkspaceV2: React.FC<MissionWorkspaceV2Props> = ({ project }) => {
  ...
  return (
    <div className="h-screen w-full max-w-full bg-background relative flex flex-col overflow-hidden">
      {/* ── Header breadcrumb (compact, identique à la v1) ── */}
      <div className="border-b border-border px-4 sm:px-5 h-14 flex items-center justify-between flex-shrink-0">
        ...
        {subsForActivePhase.map(sub => {
          ...
          return (
            <button
              ...
              disabled={locked}
              className={cn(
                'px-3 py-2.5 text-[13px] font-medium border-b-2 transition-colors flex-shrink-0',
                isActive
