...
const RangeInput: React.FC<{
  ...
  <div className="flex items-center gap-2">
    <input
      ...
      className="h-8 w-20 px-2 text-xs font-bold bg-transparent border border-border text-foreground outline-none focus:border-border"
    />
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          {/* Panel */}
          <motion.div
            className="relative z-[1] w-full sm:max-w-xl max-h-[90dvh] flex flex-col bg-background border border-border sm:mx-4 overflow-hidden pointer-events-auto"
            ...
            <div className="shrink-0 border-t-2 border-border p-4 flex items-center gap-2 bg-background">
              {currentStep > 0 && (
                <button
                  ...
                  className="h-9 px-4 text-xs font-black uppercase tracking-wider border border-border bg-background text-foreground hover:bg-foreground/[0.04] transition-colors flex items-center gap-1.5"
                >
              ...
              {isLast ? (
                <button
                  onClick={handleApply}
                  className="relative overflow-hidden flex items-center justify-center gap-2 h-9 px-5 text-xs font-black uppercase tracking-wider border border-border bg-foreground text-background group transition-colors"
                >
                ...
                <button
                  onClick={() => setCurrentStep(p => p + 1)}
                  className="flex items-center gap-1.5 h-9 px-5 text-xs font-black uppercase tracking-wider border border-border bg-foreground text-background hover:bg-foreground/90 transition-colors"
                >
                  Suivant
