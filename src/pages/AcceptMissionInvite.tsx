        ...
        {status === 'success' && (
          <>
            ...
            <button
              ...
              className="relative overflow-hidden h-[34px] px-6 bg-foreground text-background border border-foreground text-[10px] font-medium uppercase tracking-wider group"
            >
