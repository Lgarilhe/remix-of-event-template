                  ...
                  >
                    ...
                    {isPopular && (
                      <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
                        <span className="px-3 py-1 text-[9px] uppercase tracking-[0.14em] font-black bg-[hsl(var(--skalr-purple))] text-white">
                          Populaire
                        </span>
                      </div>
                    )}
                    ...
                    <div className="p-5 sm:p-6 flex flex-col flex-1">
                      ...
                      <button
                        ...
                        className={cn(
                          'w-full h-12 text-[11px] uppercase tracking-[0.14em] font-bold border-2 transition-all active:translate-y-[1px]',
                          isCurrent
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-foreground/10">
                        <th className="text-left p-3 text-[11px] uppercase tracking-[0.1em] text-muted-foreground font-bold">
                          Fonctionnalité
                        </th>
                        {plans.map((plan) => (
                          <th
                            key={plan.id}
                            className={cn(
                              'p-3 text-center text-[11px] uppercase tracking-[0.1em] font-bold',
                    ...
                    <tbody>
                      {COMPARISON_ROWS.map((row, ri) => (
                        ...
                        >
                          <td className="p-3 text-[11px] font-bold uppercase tracking-[0.1em] text-muted-foreground">
                            {row.label}
                          </td>
                          {plans.map((plan) => {
